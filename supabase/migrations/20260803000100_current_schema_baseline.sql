-- Finance Tracker Stage 1 baseline
-- Purpose: make the existing manually-applied transactions/goals schema
-- discoverable by standard Supabase migration tooling.
-- Compatibility: additive/idempotent for the current mobile client.
-- Lock profile: short DDL locks while triggers and policies are replaced.
-- Recovery: the transaction rolls back completely on failure.
...
comment on table public.transactions is
  'Transaction records used by the mobile ledger and insights.';
